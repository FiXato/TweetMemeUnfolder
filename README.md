...
I don't actively use Twitter anymore, this project is old and likely uses a deprecated version of the API, and there probably are way better alternatives, so this project is being archived.
